  ...
  return (
    <section className="px-6 py-20 text-center sm:py-28">
      <div className="container mx-auto max-w-5xl">
        ...
        <h1 className="text-balance text-5xl font-extrabold tracking-normal sm:text-6xl md:text-7xl">
          Turn shipped work into content people can follow.
        </h1>
        <p className="mx-auto mt-6 max-w-3xl text-balance text-xl leading-8 text-muted-foreground">
          CodeCook.live turns commits, diffs, and shipping notes into public progress stories, launch updates, and recap-ready posts.
        </p>
