...
- Next action: implement Clerk auth and Convex setup from `units/stage-01/01-clerk-convex-foundation.md`
...
1. `stage-01-foundation.md` - identity, Convex schema, GitHub OAuth, and app shell.
