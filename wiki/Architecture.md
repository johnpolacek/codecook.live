...
- Environment-sensitive integrations need explicit validation before deployment work: Clerk, S3-compatible storage, GitHub OAuth/API, OpenAI, artifact storage, and publish channels.
